...
int main(int argc, char const *argv[])
{
	...
	// where family specifies the protocol family (AF_INET for the IPv4 protocols), 
	// type is a constant described the type of socket (SOCK_STREAM for stream sockets and SOCK_DGRAM for datagram sockets.
	...
	// The bind() assigns a local protocol address to a socket. With the Internet protocols, 
	// the address is the combination of an  IPv4 or IPv6 address (32-bit or 128-bit) address along with a 16 bit TCP port number.
...
// To read about system calls
// https://www.cs.dartmouth.edu/~campbell/cs50/socketprogramming.html#:~:text=Bind%20the%20socket%20to%20an,client%20connects%20with%20the%20server.
